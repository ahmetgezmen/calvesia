...
import '../models/coordinators_model.dart';
import '../models/sponsor_model.dart';
import '../models/stream_time_model.dart';

class PostIsSharingAndShowingViewmodel extends ChangeNotifier{
  String _postKey = "";
  bool _isShare = false;
  bool _isShow = false;
...
class PostShareViewmodel extends ChangeNotifier {
  ...
  Future<bool> addPost(context, key,  provider, postKey ) async {
